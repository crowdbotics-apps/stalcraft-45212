"""
Django settings for stalcraft_45212 project.
...
ROOT_URLCONF = 'stalcraft_45212.urls'
...
WSGI_APPLICATION = 'stalcraft_45212.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stalcraft_45212 API",
    "DESCRIPTION": "API documentation for stalcraft_45212 App",
    "VERSION": "v1",
}
